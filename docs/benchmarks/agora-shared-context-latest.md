...
- Hub mode reduced code-index lookups by `66.7%` versus independent Agora agents.
- Hub/Without-Agora total time ratio: `0.483`
- Hub/Agora-no-hub total time ratio: `0.343`

## Per theme

| Theme | Without Agora | Agora no hub | Agora hub | Hub code-search only | Hub top paths |
| --- | ---: | ---: | ---: | ---: | --- |
