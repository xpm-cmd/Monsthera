---
id: k-burm5wh0
title: ADR-006: Opt-in `snapshot_ready` Guard for `enrichment → implementation`
slug: adr-006-opt-in-snapshot-ready-guard-for-enrichment-implementation
category: architecture
tags: []
codeRefs: [src/work/guards.ts, src/work/lifecycle.ts, scripts/capture-env-snapshot.ts, src/work/lockfile-hashes.ts, pnpm-lock.yaml, knowledge/notes/iris-meta-harness-environment-bootstrapping-and-implications-for-monsthera.md]
references: []
sourcePath: docs/adrs/006-snapshot-ready-guard.md
createdAt: 2026-06-10T09:08:17.709Z
updatedAt: 2026-06-10T09:08:17.709Z
---
